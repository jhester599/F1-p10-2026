...
+-- config.py                        # Feature list, constants, scoring table
...
|   +-- models.py                    # All model classes + EV selection logic
...
|   +-- 05_full_analysis.py          # Extended analysis and plots
|   +-- 05_recalibrate_ensemble.py   # Ensemble weight recalibration tool
|
+-- data/
...
|       +-- features_2025_2025.parquet   # 2025 eval features (479 rows)
...
cd F1-p10-2026-claude-f1-tenth-place-predictor-W0UwI
...
Current weights are stale (calibrated before the multi-class EV change).
Recalibrate with:
