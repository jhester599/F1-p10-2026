...
- Race-day processed/model cache restores require exact cache-key matches. Broad fallback restore keys are intentionally avoided for these artifacts because stale restored files can bypass rebuild/retrain existence checks.
